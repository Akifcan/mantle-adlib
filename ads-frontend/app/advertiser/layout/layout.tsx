...
import { Activity, BarChart3, Filter, Plus, Settings, Zap, Menu, X } from "lucide-react";
                ...
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-400">Advertiser</p>
                        </div>
                    </div>
            ...
            <header className="relative z-20 bg-slate-900/50 backdrop-blur-sm border-b border-slate-700/30 p-4">
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-4">
                        ...
                        {/* Header content */}
                        <div>
                            <h2 className="text-xl lg:text-2xl font-bold text-white">Dashboard Overview</h2>
                            <p className="text-sm text-slate-400 hidden sm:block">Monitor your advertising campaigns performance</p>
                        </div>
                    </div>
