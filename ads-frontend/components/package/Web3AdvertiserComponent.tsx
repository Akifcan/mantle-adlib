...
interface AdResponse {
  ...
  interface Web3AdvertiserComponentProps {
    id: string | number
    type: string
    onReward?: () => void
  }
...
function Web3AdvertiserComponent({ id, type, onReward }: Web3AdvertiserComponentProps) {
    ...
    // Reward timer - 15 saniye geri sayım
    useEffect(() => {
    ...
    // Reward tipi için full screen modal - 15 saniye timer ile
  ...
  export default Web3AdvertiserComponent
